...
import Default from "./DashboardContentComponents/default.component";
...
import Yardim from "./DashboardContentComponents/yardim.component";
import Ayarlar from "./DashboardContentComponents/settings.component";
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          {[
            ...
            { text: "Kullanıcı Ekle", icon: <AttributionIcon /> },
            { text: "Onay al", icon: <ViewInAr />},
            { text: "Belgeler", icon: <TextSnippet />},
            { text: "Onay Testleri", icon: <Approval />},
            { text: "Departmanlar", icon: <Lan /> },
            { text: "Yardım", icon: <ImportContacts />},
            { text: "Ayarlar", icon: <Settings /> },
          ].map((text, index) => (
